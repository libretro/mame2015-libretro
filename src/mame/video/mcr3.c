...
*/
		...
		if (!mcr_cocktail_flip)
		{
			...
			m_gfxdecode->m_gfx[1]->prio_transmask(bitmap,cliprect, code, color, flipx, flipy, sx, sy,
		...
		{
			/* first draw the sprite, visible */
			m_gfxdecode->m_gfx[1]->prio_transmask(bitmap,cliprect, code, color, !flipx, !flipy, 480 - sx, 452 - sy,
					screen.priority(), 0x00, 0x0101);
