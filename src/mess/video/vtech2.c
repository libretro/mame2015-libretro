		...
		case  1:
			...
			for( y = 0; y < 192; y++ )
			{
				...
				for( x = 0; x < 80; x++, offs++ )
				{
					...
					sx = BORDER_H/2 + x * 8;
					code = videoram[offs];
					m_gfxdecode->m_gfx[2]->opaque(bitmap,cliprect,code,color,0,0,sx,sy);
				}
			}
			break;
		...
		case 2:
			...
			for( y = 0; y < 192; y++ )
			{
				...
				for( x = 0; x < 40; x++, offs += 2 )
				{
					...
					m_gfxdecode->m_gfx[3]->opaque(bitmap,cliprect,code,color,0,0,sx,sy);
				}
			}
			break;
		...
		case  3:
			...
			for( y = 0; y < 192; y++ )
			{
				...
				for( x = 0; x < 80; x++, offs++ )
				{
					...
					sx = BORDER_H/2 + x * 8;
					code = videoram[offs];
					m_gfxdecode->m_gfx[5]->opaque(bitmap,cliprect,code,0,0,0,sx,sy);
				}
			}
			break;
		...
		case  5:
			...
			for( y = 0; y < 96; y++ )
			{
				...
				for( x = 0; x < 80; x++, offs++ )
				{
					...
					sx = BORDER_H/2 + x * 8;
					code = videoram[offs];
					m_gfxdecode->m_gfx[6]->opaque(bitmap,cliprect,code,0,0,0,sx,sy);
				}
			}
			break;
		...
		case  7:
			...
			for( y = 0; y < 192; y++ )
			{
				...
				for( x = 0; x < 20; x++, offs += 2 )
				{
					...
					code = videoram[offs];
					color = videoram[offs+1];
					m_gfxdecode->m_gfx[4]->opaque(bitmap,cliprect,code,color,0,0,sx,sy);
				}
			}
			break;
		}
		...
		else
		{
			...
			for( y = 0; y < 24; y++ )
			{
				...
				for( x = 0; x < 40; x++, offs += 2 )
				{
					...
					m_gfxdecode->m_gfx[1]->opaque(bitmap,cliprect,code,color,0,0,sx,sy);
				}
			}
		}
	}
